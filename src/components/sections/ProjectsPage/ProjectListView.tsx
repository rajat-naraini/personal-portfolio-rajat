...
const ProjectListView: React.FC<ProjectListViewProps> = ({ projects, toggleProject }) => {
  return (
              ...
              <div className="w-full md:w-3/4">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-emerald-400 mb-2">{project.year}</p>
                  </div>
                ...
                <p className="text-gray-300 mb-3">{project.shortDescription}</p>
